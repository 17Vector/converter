...
class Section1 extends State<Section1Screen> {
  ...
  Widget ButtonStyle(String label, int rowIndex) {
    ...
    if (selectedUnits[rowIndex] == label && ['t', 'kg', 'g', 'lb', 'oz'].contains(label)) {
    ...
    if (['t', 'kg', 'g', 'lb', 'oz'].contains(label)) {
      valButWidth = 60;
      valButHeight = 60;
      valButFontSize = 25;
  ...
  void conversion () {
    ...
    double baseValue = toKilogram(writtenNumb, value1);
  ...
  double toKilogram(value, String unit) {
